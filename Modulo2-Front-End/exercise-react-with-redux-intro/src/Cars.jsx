...
import {moveCar as moveCar2} from './redux/actionCreators';

 function Cars({
  redCar, blueCar, yellowCar, moveCar,
}) {
console.log(redCar,"valor do redcar");
...
const mapStateToProps = (state) => ({ // mapeia os dados armazenados nos estados, para uma props
