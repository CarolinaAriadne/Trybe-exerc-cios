...
const objectsArray = books.map((object) => object.author.name);

//   console.log(objectsArray);

const createString = objectsArray.reduce((acumulador, elemento) => {
...
// const createString = objectsArray.reduce((acumulador, elemento) => acumulador.concat(elemento), '');
